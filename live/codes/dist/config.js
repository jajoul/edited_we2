...
export const CALL_PRIVATE_ACCESS = process.env.CALL_PRIVATE_ACCESS || 'true';
...
export const DJANGO_WEBHOOK_URL = process.env.DJANGO_WEBHOOK_URL || 'http://62.60.164.69:8000/api/website/v1/live/end/';
export const DJANGO_WEBHOOK_URL_START = process.env.DJANGO_WEBHOOK_URL || 'http://62.60.164.69:8000/api/website/v1/live/start/';
export const DJANGO_WEBHOOK_PORT = process.env.DJANGO_WEBHOOK_PORT || 8000;
export const DJANGO_WEBHOOK_PATH = process.env.DJANGO_WEBHOOK_PATH || '/api/website/v1/live/finished';
