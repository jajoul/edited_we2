import { RecordingOutputMode, RecordingStatus } from '../models/recording.model.js';
import { EgressStatus } from '@livekit/protocol';
import { DataTopic } from '../models/signal.model.js';
export class RecordingHelper {
    static toRecordingInfo(egressInfo) {
     ...
     */
    static isRecordingEgress(egress) {
     ...
     */
    static extractOutputMode(egressInfo) {
    ...
    static extractLocation(egressInfo) {
...
//# sourceMappingURL=recording.helper.js.map