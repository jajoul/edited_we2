...
import { LIVEKIT_URL, LIVEKIT_API_KEY, LIVEKIT_API_SECRET, SERVER_PORT, CALL_PRIVATE_ACCESS, CALL_SECRET, CALL_USER, CALL_ADMIN_SECRET, LIVEKIT_URL_PRIVATE, CALL_AWS_S3_BUCKET, CALL_AWS_S3_SERVICE_ENDPOINT, CALL_AWS_ACCESS_KEY, CALL_AWS_SECRET_KEY } from './config.js';
dotenv.config();
const app = express();
// Enable CORS support
...
app.listen(SERVER_PORT, () => {
    ...
    console.log('---------------------------------------------------------');
    console.log('CALL PRIVATE ACCESS: ', CALL_PRIVATE_ACCESS === 'true' ? enabled(CALL_PRIVATE_ACCESS) : disabled(CALL_PRIVATE_ACCESS));
